        ...
        <View>
          ...
          <View style={{alignItems: 'center', justifyContent: 'center'}}>
            <TouchableOpacity onPress={() => this.props.navigation.navigate('ContactScreen')}>
              <View style={styles.roundedButton}>
                <Text style={{textAlign: 'center', padding: 20, color: 'white', fontFamily: 'Kanit-Regular', fontSize: 14}}>ดูข้อมูลติดต่อแหล่งช่วยเหลือ</Text>
              </View>
            </TouchableOpacity>
          </View>
          ...
          <View style={{alignItems: 'center', justifyContent: 'center'}}>
            ...
            >
              <View style={styles.roundedButton}>
                <Text style={{textAlign: 'center', padding: 20, color: 'white', fontFamily: 'Kanit-Regular', fontSize: 14}}>เริ่มทำโปรแกรม</Text>
              </View>
            </TouchableOpacity>
          </View>
        </View>
